...
final class RepoListErrorView: UIView {
    ...
    private let errorTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Houve um erro ao carregar repositórios"
    ...
    private let errorDescLabel: UILabel = {
        let label = UILabel()
        label.text = "Não foi possível carregar a lista de repositórios do GitHub. Gostaria de tentar carregar novamente?"
